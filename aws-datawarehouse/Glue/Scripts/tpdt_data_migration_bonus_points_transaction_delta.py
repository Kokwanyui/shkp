...
date_format(t1.created_date,"yyyy-MM-dd'T'HH:mm:ss'.000Z'")  as LEGACY_Activity_Date_Time__c,
'' as LEGACY_Shop__c,
...
'' as LEGACY_Receipt_Updated_By__c,
t1.member_id as LEGACY_Member__c,
t2.points as LEGACY_Earned_Converted_Redeemed_Points__c,
'' as LEGACY_Approval_Date__c,
'' as LEGACY_Reject_Reason__c,
...
'' as LEGACY_Receipt_Updated_By__c,
t1.member_id as LEGACY_Member__c,
t2.redeemed_bonus_points * -1 as LEGACY_Earned_Converted_Redeemed_Points__c,
'' as LEGACY_Approval_Date__c,
'' as LEGACY_Reject_Reason__c,
...
'' as LEGACY_Receipt_ID__c,
'' as LEGACY_Created_By__c,
date_format(t4.created_date,"yyyy-MM-dd'T'HH:mm:ss'.000Z'") as LEGACY_Created_Date__c,
'' as LEGACY_Updated_Date__c,
'' as LEGACY_Partner_ID__c,
'' as LEGACY_Platform__c,
'' as LEGACY_Channel__c,
...
'' as LEGACY_Expiry_Date__c,
'' as LEGACY_Reserve_Date_Time__c,
date_format(t2.cancel_datetime,"yyyy-MM-dd'T'HH:mm:ss'.000Z'") as LEGACY_Cancel_Date_Time__c,
'' as LEGACY_Used_Date_Time__c,
'' as LEGACY_Linked_Sales_Amount__c,
'' as LEGACY_Min_Spending_Amount__c,
'' as LEGACY_Point_Dollar_Transaction_Amount__c,
...
'' as LEGACY_Receipt_Updated_By__c,
t1.member_id as LEGACY_Member__c,
t2.redeem_bonus_points * -1 as LEGACY_Earned_Converted_Redeemed_Points__c,
'' as LEGACY_Approval_Date__c,
'' as LEGACY_Reject_Reason__c,
t2.redeem_type as LEGACY_Type__c,
'' as LEGACY_Auto_Approved__c,
...
date_format(t2.expiry_date,"yyyy-MM-dd'T'HH:mm:ss'.000Z'") as LEGACY_Expiry_Date__c,
'' as LEGACY_Reserve_Date_Time__c,
date_format(t2.cancel_datetime,"yyyy-MM-dd'T'HH:mm:ss'.000Z'") as LEGACY_Cancel_Date_Time__c,
date_format(t2.used_datetime,"yyyy-MM-dd'T'HH:mm:ss'.000Z'") as LEGACY_Used_Date_Time__c,
...
'' as LEGACY_Expiry_Date__c,
date_format(t2.event_session_end_time,"yyyy-MM-dd'T'HH:mm:ss'.000Z'") as LEGACY_Reserve_Date_Time__c,
'' as LEGACY_Cancel_Date_Time__c,
'' as LEGACY_Used_Date_Time__c,
'' as LEGACY_Linked_Sales_Amount__c,
'' as LEGACY_Min_Spending_Amount__c,
